  ...
  return (
    <>
      <div className="flex flex-col items-start gap-6">
        <h2 className="max-w-xl font-geist-mono text-sm font-normal tracking-tight text-zinc-700 dark:text-zinc-300">
          ...
          <a
            ...
            className="text-blue-500 dark:text-blue-400 text-sm font-geist-mono underline tracking-tight underline-offset-2 transition-colors hover:text-[#FF5F1F]"
          >
            {contact.email}
          </a>.
        </h2>
