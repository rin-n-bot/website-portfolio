  ...
  return (
    <>
      <div className="flex flex-col items-start gap-6">
        <h2 className="max-w-xl font-geist text-md font-normal tracking-normal text-zinc-700 dark:text-zinc-300">
          ...
          <a
            ...
            className="align-middle inline-flex items-center gap-1.5 rounded-sm bg-zinc-100 px-2 py-0.5 text-[13px] font-medium tracking-normal text-blue-500 transition-colors hover:text-[#FF5F1F] dark:bg-zinc-800/50 dark:text-blue-500"
          >
